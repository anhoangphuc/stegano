...
class Hidden:
    def __init__(self, configuration: HiDDenConfiguration, device: torch.device, noiser: Noiser, tb_logger):
        ...
        self.optimizer_enc_dec = torch.optim.Adam(self.encoder_decoder.parameters(), lr=0.001)
        self.optimizer_discrim = torch.optim.Adam(self.discriminator.parameters(), lr=0.001)
